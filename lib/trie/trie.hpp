...
//private:
//  explicit trie_node(size_type __num_words, size_type __num_prefix, chi
  size_type _M_words;
  size_type _M_prefix;
...
xyz:
  ...
  {
    if (_M_cur_node) _M_child_iter = _M_cur_node->_M_children.begin();
  }
